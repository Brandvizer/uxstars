...
export const metadata: Metadata = {
  title: "Over ons",
  description:
    "Waarom UXSTARS bestaat: een netwerk waar digital designers voor elkaar instaan en opdrachtgevers zonder ruis de juiste mensen vinden.",
};
    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
      <div className="max-w-3xl">
        ...
        <div className="mt-6 space-y-5 text-xl text-tekst-secundair">
          <p>
            De markt voor designtalent is kapot op twee manieren tegelijk.
